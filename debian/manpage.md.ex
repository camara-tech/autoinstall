% autoinstall(SECTION) | User Commands
%
% "August  8 2022"
...
autoinstall - program to do something

# SYNOPSIS

**autoinstall** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**autoinstall** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **autoinstall** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**autoinstall** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    autoinstall. See **foo.conf**(5) for further details.
...
**autoinstall** provides some return codes, that can be used in scripts:
...
Jonathan Camara <owner@unknown>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Jonathan Camara
